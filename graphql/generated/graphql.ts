...
export type GetAllTournamentsQuery = { __typename?: 'Query', getAllTournaments: { __typename?: 'TournamentListResponse', totalRecords: number, tournaments: Array<{ __typename?: 'Tournament', id: any, name: string, description: string, start_date: any, end_date: any, isPrivate: boolean, created_at: any, updated_at: any, format: { __typename?: 'Format', name: FormatType }, club: { __typename?: 'Club', name: string }, sport: { __typename?: 'Sport', name: SportName } }> } };
